...
<head>
    ...
    <style>
        ...
        .badge-success { background: #198754; color: white; padding: 4px 10px; border-radius: 20px; }
        .badge-danger { background: #dc3545; color: white; padding: 4px 10px; border-radius: 20px; }
        .badge-warning { background: #ffc107; color: black; padding: 4px 10px; border-radius: 20px; }
        .badge-secondary { background: #6c757d; color: white; padding: 4px 10px; border-radius: 20px; }
    </style>
</head>
<body>
    <div class="card">
        <h2>📋 Application Status Updated</h2>
        <p>Your application for <strong>{{ $application->jobPost->title }}</strong> has been updated.</p>
        ...
        <p>New Status:
            ...
            @elseif($application->status === 'reviewed')
                <span class="badge-warning">👀 Reviewed</span>
            @else
        ...
        <p style="margin-top: 30px; color: #999; font-size: 12px;">
            You received this email because you applied for a job on MyJobApp.
        </p>
    </div>
</body>
</html> --}}
