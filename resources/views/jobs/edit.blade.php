            ...
            <div class="col-md-8">
                ...
                <form method="POST" action="{{ route('jobs.update', $jobPost->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="job_description" class="form-control" rows="4" required>{{ old('job_description', $jobPost->job_description) }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label>Job Requirements</label>
                        <textarea name="job_requirements" class="form-control" rows="4" required>{{ old('job_requirements', $jobPost->job_requirements) }}</textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('jobs.mine') }}" class="btn btn-secondary w-100">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
